migrate((db) => {
  ...
  // remove
  collection.schema.removeField("s6d2ujit")

  // remove
  collection.schema.removeField("1yhlvk5j")

  // remove
  collection.schema.removeField("sjxboqa2")

  // remove
  collection.schema.removeField("tipvngek")

  // remove
  collection.schema.removeField("shiidrkm")

  // remove
  collection.schema.removeField("wccebhky")

  // remove
  collection.schema.removeField("yqpi5mkz")
