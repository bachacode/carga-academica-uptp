...
<template>
  <CardContainer :card-width="formWidth">
    <h1 v-if="formTitle" class="pl-2 pt-2 text-xl font-bold text-zinc-600 uppercase">{{ formTitle }}</h1>
    <button
      v-if="backButton"
      class="btn bg-indigo-600 ml-2 mt-2 hover:bg-indigo-800 rounded-lg"
      @click="router.back()"
    >
