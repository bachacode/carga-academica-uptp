...
<template>
  <CardContainer :card-width="formWidth">
    ...
    <form class="mt-4 px-6 pb-6" @submit.prevent="$emit('formSubmit')">
      ...
      <!-- Loading Submit -->
      <button v-show="isLoading" disabled type="button" class="text-md w-full rounded-lg bg-blue-700 px-6 py-3 text-center font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto">
