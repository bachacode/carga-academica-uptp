...
<nav aria-label="Page navigation" class="pt-1">
  <ul class="flex -space-x-px justify-end">
    <li>
      <a href="#" class="px-3 py-2 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-bl-lg hover:bg-gray-100 hover:text-gray-700">Anterior</a>
    </li>
    <li>
    ...
    <li>
      <a href="#" aria-current="page" class="px-3 py-2 text-white border border-gray-300 bg-blue-700 hover:bg-blue-100 hover:text-blue-700">3</a>
    </li>
    <li>
      <a href="#" class="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 rounded-br-lg hover:bg-gray-100 hover:text-gray-700">Siguiente</a>
    </li>
  </ul>
</nav>
</div>
