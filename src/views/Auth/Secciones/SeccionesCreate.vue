      ...
      <div class="w-2/4 px-16 pb-8">
        <div class="rounded border bg-white shadow">
          ...
          >
            ...
            <InputError class="pl-1 pt-1" v-if="v$.codigo.$error" :message="v$.codigo.$errors[0].$message"></InputError>
            <InputField type="number" placeholder="2" name="Trayecto" v-model="formData.trayecto"></InputField>
            <InputError class="pl-1 pt-1" v-if="v$.trayecto.$error" :message="v$.trayecto.$errors[0].$message"></InputError>
            <InputField type="number" placeholder="17" name="Estudiantes" v-model="formData.estudiantes"></InputField>
            <InputError class="pl-1 pt-1" v-if="v$.estudiantes.$error" :message="v$.estudiantes.$errors[0].$message"></InputError>
            <button type="submit" class="btn bg-blue-700 text-white hover:bg-blue-900 mt-3">
              Crear Sección
            </button>
          </form>
        </div>
