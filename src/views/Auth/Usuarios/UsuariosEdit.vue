...
<template>
  <AuthLayout>
    ...
    <template v-if="formType == ''">
      ...
      <CardContainer card-width="2/4 mt-20">
        <div class="p-6 space-x-6 h-44">
          <h1 class="pb-3 px-6 text-xl font-bold">{{ `Editar a ${formData.username}` }}</h1>
        <button
    ...
    >
      <template #inputs>
        ...
        <InputField type="password" label="Contraseña" name="password">
          <template #InputField><InputComponent name="password" v-model="formData.password" /></template>
          <template #InputError
        ...
        <InputField type="password" label="Confirmar Contraseña" name="passwordConfirm">
          <template #InputField><InputComponent name="passwordConfirm" v-model="formData.passwordConfirm" /></template>
          <template #InputError
